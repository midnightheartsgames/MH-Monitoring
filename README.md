...
- **Трей и горячие клавиши:** показать или скрыть оверлей, заблокировать его, открыть
  настройки, выйти.
- **Окно настроек:** секции и отдельные строки HUD, масштаб, прозрачность, поведение в
  эксклюзивном полноэкранном режиме, запуск старых игр в окне без рамки, выбор цели, свой PresentMon, горячие клавиши, служба,
...
выбирается в окне первого запуска или в настройках (раздел «Оверлей»):
